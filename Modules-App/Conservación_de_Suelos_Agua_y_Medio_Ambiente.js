...
const Conservación_de_Suelos_Agua_y_Medio_Ambiente = () => {
                ...
                <ScrollView>
                    <View style={styles.content}>
                        ...
                        <View style={styles.contentTitle}>
                            <Text
                                style={styles.Title}
                                variant="titleLarge" >Conservación de Suelos, Agua y Medio Ambiente</Text>
                        </View>
                        ...
                        <Card style={styles.card}>
                            <Text>Siembra de cultivos en Curvas a Nivel</Text>
...
export default Conservación_de_Suelos_Agua_y_Medio_Ambiente;

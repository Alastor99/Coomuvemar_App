...
const Riesgos_de_Contaminación_en_la_Finca = () => {
                ...
                <ScrollView>
                    <View style={styles.content}>
                        ...
                        <View style={styles.contentTitle}>
                            <Text
                                style={styles.Title}
                                variant="titleMedium" >Riesgos de Contaminación en la Finca</Text>
                        </View>
                        ...
                        <Card style={styles.card}>
                            <Text>Colinda con lotes convencionales</Text>
                        ...
                        <Card style={styles.card}>
                            <Text>Tiene zonas de Amortiguamiento?</Text>
                        ...
                        <Card style={styles.card}>
                            <Text>Produce otros cultivos con químicos en la Finca?</Text>
...
export default Riesgos_de_Contaminación_en_la_Finca;
